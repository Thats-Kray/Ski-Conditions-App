...
function ProfileStep({ onNext, onSkip }) {
  ...
  return (
    <div style={{ padding: "28px 24px 28px", display: "grid", gap: 18 }}>
      ...
      {error && <div style={{ fontSize: 13, color: "#fda4af", background: "rgba(244,63,94,0.1)", borderRadius: 10, padding: "9px 12px" }}>{error}</div>}

      <div style={{ display: "flex", gap: 10 }}>
        <button onClick={onSkip} style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 14, padding: "12px 18px", color: "rgba(255,255,255,0.5)", fontWeight: 700, cursor: "pointer", fontSize: 13 }}>Skip for now</button>
        <button onClick={handleSave} disabled={saving} style={{ flex: 1, background: saving ? "rgba(255,255,255,0.08)" : "linear-gradient(135deg,#2563eb,#0891b2)", color: saving ? "rgba(255,255,255,0.4)" : "white", border: "none", borderRadius: 14, padding: "12px", fontWeight: 900, cursor: saving ? "wait" : "pointer", fontSize: 14, boxShadow: saving ? "none" : "0 6px 24px rgba(37,99,235,0.35)" }}>
...
function FriendsStep({ onNext }) {
  ...
  return (
    <div style={{ padding: "28px 28px 28px", display: "grid", gap: 18 }}>
      <div>
      ...
      <div style={{ display: "flex", gap: 10 }}>
        ...
        <button onClick={onNext} style={{ flex: 1, background: "linear-gradient(135deg,#2563eb,#0891b2)", color: "white", border: "none", borderRadius: 14, padding: "12px", fontWeight: 900, cursor: "pointer", fontSize: 14, boxShadow: "0 6px 24px rgba(37,99,235,0.35)" }}>
